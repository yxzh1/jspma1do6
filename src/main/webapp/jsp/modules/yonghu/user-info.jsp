...
<div id="main-container">
    ...
    <div id="add-container">
        <form id="addOrUpdateForm">
            ...
            <div class="form-item">
                <label>用户名</label>
                <input name="yonghuming" readonly id="yonghuming" name="yonghuming" class="form-control"
                       placeholder="请输入用户名">
            </div>
            <div class="form-item">
                <label>姓名</label>
            ...
            <div class="form-item-img">
                ...
                <div class="upload btn-img">选择文件<input name="file" type="file" id="touxiangupload"
            ...
            <div class="form-item">
                <label>身份证</label>
                <input name="shenfenzheng" id="shenfenzheng" name="shenfenzheng" class="form-control"
                       placeholder="请输入身份证">
            </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            console.log("user-info----------getItem(id)---",id)
