        ...
        function getDataList() {
			http("zulinjilu/page","GET",{
				...
				if(res.code == 0){
					...
					console.log("zulinjilu/page---------->",dataList)
					//var tbody = document.getElementById('tbMain');
					for(var j = 0;j < dataList.length; j++){
						if(dataList[j].zulinzhuangtai === "已归还"){
							dataList[j].zulinzhuangtai = "未租赁"
						}
						if(dataList[j].zulinzhuangtai === "未归还"){
							dataList[j].zulinzhuangtai = "已租赁"
						}
					}
